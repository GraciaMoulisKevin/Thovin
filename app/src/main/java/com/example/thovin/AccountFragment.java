...
public class AccountFragment extends Fragment {
    ...
    private void configureTextInputLayout() {
        name = this.rootView.findViewById(R.id.fragment_account_name);
        firstName = this.rootView.findViewById(R.id.fragment_account_first_name);
        mail = this.rootView.findViewById(R.id.fragment_account_mail);
        address = this.rootView.findViewById(R.id.fragment_account_address);
        additionalAddress = this.rootView.findViewById(R.id.fragment_account_additional_address);
        city = this.rootView.findViewById(R.id.fragment_account_city);
        postalCode = this.rootView.findViewById(R.id.fragment_account_postal_code);
        phone = this.rootView.findViewById(R.id.fragment_account_phone);
    }
